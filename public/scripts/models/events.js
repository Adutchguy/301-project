...
(function(module) {
  ...
  events.requestEvents = (callback) => {
    $.get(`https://app.ticketmaster.com/discovery/v2/events.json?size=25&sort=date,name,asc&city=Seattle&classificationName=Music&apikey=aPLdF6GC2G6nLNrygytPbkvPzCU7CjGS`)
